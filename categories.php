...
<nav class=" custombreadcrumb">
	<div class="nav-wrapper section-rule">
		<div class="col s12">
			...
			<a href="./allcategories.php" class="breadcrumb">All Categories</a>
			<a href="#!" class="breadcrumb">Chair</a>
...
<main class="categories-page">
	<section class="home section-rule">
		<div class="owl-carousel owl-theme">
			<div class="item">
				<div class="image">
					<img src="./images/JPEG/michael-warf-f8egRYt5RGk-unsplash.jpg" alt="homeimage of hdfurniturehub">
				</div>

				<div class="text">
					<h1><mark>get all suitable</mark> <br> <mark>chair for your</mark><br> <mark>cafe</mark></h1>
					<button onclick="window.location.href='./single-page.php'">
						shop now
					</button>
				</div>
			</div>
			<div class="item">
				<div class="image">
					<img src="./images/JPEG/ionut-vlad-idXQEOxhmvU-unsplash.jpg" alt="homeimage of hdfurniturehub">

				</div>
				<div class="text">
					<h1><mark>Looking for a</mark> <br> <mark>chair that enhance</mark><br> <mark>your home office</mark></h1>
					<button onclick="window.location.href='./single-page.php'">
						shop now
					</button>
				</div>
			...
			<aside class="col s12 m12 l9 all-part">
				<article class="newarrival">
					<div class="row">
						...
						<h2 class="section-title">Categories: <span>Chair</span><span>(Latest)</span></h2>
